...
@Builder
@NoArgsConstructor
@TypeAlias("Activation token")
@ToString(includeFieldNames = true)
@Document(collection = ActivationToken.ACTIVATION_TOKEN_COLLECTION_NAME)
public class ActivationToken implements Serializable {
	...
	public static final String ACTIVATION_TOKEN_COLLECTION_NAME = "ACTIVATION_TOKEN";
	...
	@Builder
	public ActivationToken(String username, String token, LocalDateTime creationDate, LocalDateTime expiredTime,
			String status) {
